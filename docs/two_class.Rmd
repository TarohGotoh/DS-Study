...
参考）[永田・棟近（2001）多変量解析入門 サイエンス社](https://www.amazon.co.jp/%E5%A4%9A%E5%A4%89%E9%87%8F%E8%A7%A3%E6%9E%90%E6%B3%95%E5%85%A5%E9%96%80-%E3%83%A9%E3%82%A4%E3%83%96%E3%83%A9%E3%83%AA%E6%96%B0%E6%95%B0%E5%AD%A6%E5%A4%A7%E7%B3%BB-%E6%B0%B8%E7%94%B0-%E9%9D%96/dp/4781909809) p111-p112
...
predict_two_class_qda <- function(result, data) {
    ...
    diff_d <- d_2-d_1
    score <- log(sqrt(two_class_det[[2]]/two_class_det[[1]])) + 1/2*(diff_d) + log(theta/(1-theta))
    # 判別結果の分類
    class <- ifelse(score >= 0, "group_1", "group_2")
    # 結果の格納
    return(list(score = as.vector(score), 
